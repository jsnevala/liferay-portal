	...
	"LiferayDocumentType": {
		...
		"dynamic_templates": [
			...
			},
			{
				"template_en": {
					"mapping": {
						"analyzer": "gsearch_english_analyzer",
						"store": true,
						"term_vector": "with_positions_offsets",
						"type": "text"
					},
			...
			},
			{
				"template_fi": {
					"mapping": {
						"analyzer": "gsearch_finnish_analyzer",
						"store": true,
						"term_vector": "with_positions_offsets",
						"type": "text"
					},
			...
			},
			{
				"template_sv": {
					"mapping": {
						"analyzer": "gsearch_swedish_analyzer",
						"store": true,
						"term_vector": "with_positions_offsets",
						"type": "text"
					},
		...
		"properties": {
			...
			"content": {
				"analyzer": "gsearch_standard_analyzer",
				"store": true,
				"term_vector": "with_positions_offsets",
				"type": "text"
			},
			...
			"gsearch_version_count": {
				"store": true,
				"type": "double"
			},			
			"gsearch_content_length": {
				"store": true,
				"type": "integer"
			}		
		}
